...
def model_Evaluate(model_name, tweets, output_file, prediction, labels_gold):    
    save_output_tsv(model_name, tweets, prediction, output_file)
    # Print the evaluation metrics for the dataset.
    #if y_test:
    print("\n")
    print(classification_report(labels_gold, prediction))
